...
import { CHRISTINA_POLLS_CHANNEL_ID, EIGHT_EMOJI, FIVE_EMOJI, FOUR_EMOJI, NINE_EMOJI, ONE_EMOJI, SEVEN_EMOJI, SIX_EMOJI, THREE_EMOJI, TWO_EMOJI } from "../../constants.js";

const numToUnicodeEmojiMap: Map<number, string> =
    new Map([
        [1, ONE_EMOJI],
        [2, TWO_EMOJI],
        [3, THREE_EMOJI],
